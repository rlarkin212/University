<%@ Page Title="Module Specification" Language="C#" MasterPageFile="~/Academic/Academic.Master" AutoEventWireup="true" CodeBehind="AcademicModuleSpec.aspx.cs" Inherits="CIT12.Academic.AcademicModuleSpec" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

    <script>
        function printGV() {
            var prtContent = document.getElementById('<%= pnlModuleSpec.ClientID %>')
    ...
    <asp:Panel ID="pnlModuleSpec" runat="server">
        <div class="row">
