...
{
    public partial class AcademicTimetable : System.Web.UI.Page
    {
        ...
        protected void gvAcademicTimetable_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            foreach (GridViewRow row in gvAcademicTimetable.Rows)
            {
