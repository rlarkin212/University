...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pnlCourseClassList" runat="server">
        ...
        <div class="row">
            ...
            <asp:SqlDataSource runat="server" ID="dsAcademicCourseClassList" ConnectionString='<%$ ConnectionStrings:ApplicationConnection %>' SelectCommand="SELECT DISTINCT tbl_user.Id, tbl_user.Number,CONCAT(tbl_user.Forename, ' ', tbl_user.Surname) AS FullName, tbl_user.EmailAddress, tbl_studentUser.StudentLevel FROM tbl_user INNER JOIN tbl_studentUser ON tbl_user.Id = tbl_studentUser.StudentId INNER JOIN tbl_studentCourse ON tbl_studentUser.StudentId = tbl_studentCourse.StudentId WHERE (tbl_studentCourse.CourseId = @courseId) ORDER BY FullName" FilterExpression="StudentLevel = '{0}'">
                <SelectParameters>
