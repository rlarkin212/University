...
namespace CIT12
{
    public class Email
    {
        ...
        public static bool SendEmail(MailAddress toAddress, string header, string subject, string body, string fileName, string file)
        {
            ...
            if (fileName.Length > 0 && file.Length > 0)
            {
                ...
                newPM.Attachments.Add(attachment);
            }
