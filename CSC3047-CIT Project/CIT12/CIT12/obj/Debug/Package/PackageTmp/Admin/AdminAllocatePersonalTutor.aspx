<%@ Page Title="Allocate Personal Tutor" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AdminAllocatePersonalTutor.aspx.cs" Inherits="CIT12.Admin.AdminAllocatePersonalTutor" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

    <ul class="breadcrumb">
        <li><a href="AdminHome.aspx">Home</a></li>
        <li><a href="AdminStudentAcademic.aspx">Manage Student Info</a></li>
        <li class="active">Allocate Personal Tutor</li>
    </ul>



    <div class="heading">
        <h3>Assign Personal Tutor</h3>
    </div>
    <br />
    ...
    <asp:Panel ID="pnlAcademics" runat="server" Visible="false">
        ...
        <asp:SqlDataSource runat="server" ID="dsAcademic" ConnectionString='<%$ ConnectionStrings:ApplicationConnection %>' SelectCommand="SELECT tbl_user.Id, tbl_user.Number, CONCAT(tbl_user.Forename, ' ', tbl_user.Surname) AS FullName FROM tbl_user WHERE (tbl_user.Role = @role)" FilterExpression="Number LIKE '{0}%'">
            <SelectParameters>
