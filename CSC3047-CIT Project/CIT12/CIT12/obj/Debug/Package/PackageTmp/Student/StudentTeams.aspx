...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pnlAddTeamMembers" runat="server" Visible="false">
        ...
        <div class="row">
            ...
            <asp:SqlDataSource runat="server" ID="dsStudents" ConnectionString='<%$ ConnectionStrings:ApplicationConnection %>' SelectCommand="SELECT DISTINCT tbl_user.Id, CONCAT(tbl_user.Forename, ' ', tbl_user.Surname) AS FullName, tbl_user.EmailAddress, tbl_modules.Id AS ModuleId FROM tbl_user INNER JOIN tbl_studentModule ON tbl_user.Id = tbl_studentModule.StudentId INNER JOIN tbl_modules ON tbl_studentModule.ModuleId = tbl_modules.Id WHERE(tbl_modules.Id = @ddlModuleId)" FilterExpression="EmailAddress LIKE '{0}%'">
                <SelectParameters>
