<%@ Page Language="C#" AutoEventWireup="true" CodeFile="itemsForSale.aspx.cs" Inherits="_Default" %>
...
<body>
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
     ...
     <div class="navbar-form pull-right" role="search">
        ...
        <asp:SqlDataSource ID="itemsForSaleSource" runat="server" ConnectionString="<%$ ConnectionStrings:elmTreeConnection %>" SelectCommand="SELECT Id,Name,Price,PostedDate,ImagePath FROM itemsForSale WHERE visability = 1 ORDER BY PostedDate DESC"></asp:SqlDataSource>

        <div class="jumbotron">
            <div class="container">
                
                <div class="col-lg-12">
                <h1 class="page-header">Items For Sale</h1>
                </div>
                
                <div class="row">
                    
                    <asp:ListView ID="itemsForSale" runat="server" DataSourceID="itemsForSaleSource">
                        <ItemTemplate>
